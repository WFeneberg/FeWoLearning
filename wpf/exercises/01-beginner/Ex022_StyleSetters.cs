// Exercise 022 - Style setters, applied in code (beginner).
...
public static class Ex022_StyleSetters
{
    ...
    public static Style BuildStyle(double width, string tag)
        ...
        //       return style;
        => throw new NotImplementedException("TODO: Ex022 - build a Style with TargetType typeof(Button) and two Setters: Button.WidthProperty = width, Button.TagProperty = tag");
    ...
    public static void Apply(Button button, Style style)
        // TODO: button.Style = style;
        => throw new NotImplementedException("TODO: Ex022 - assign style to button.Style");
}
