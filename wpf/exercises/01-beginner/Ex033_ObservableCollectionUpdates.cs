// Exercise 033 - ObservableCollection updates reaching generated containers (beginner).
...
public static class Ex033_ObservableCollectionUpdates
{
    ...
    public static ItemsControl BuildItemsControl(ObservableCollection<Ex033_Task> tasks)
        // TODO: var template = new DataTemplate(typeof(Ex033_Task));
        ...
        => throw new NotImplementedException("TODO: Ex033 - build a DataTemplate(typeof(Ex033_Task)) with a FrameworkElementFactory(typeof(TextBlock)) bound to Ex033_Task.Title, and return a new ItemsControl with ItemsSource set to the SAME tasks reference (not tasks.ToList() or any other copy) and ItemTemplate set to that template");
}
