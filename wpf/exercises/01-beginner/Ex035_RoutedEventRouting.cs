// Exercise 035 - Routed event routing: bubble, tunnel and Handled (beginner).
...
public static class Ex035_RoutedEventRouting
{
    ...
    public static RoutedEventArgs RaiseItemActivatedPair(UIElement source)
        // TODO: var args = new RoutedEventArgs(PreviewItemActivatedEvent, source);
        //       source.RaiseEvent(args);
        //       args.RoutedEvent = ItemActivatedEvent;
        //       source.RaiseEvent(args);
        //       return args;
        => throw new NotImplementedException("TODO: Ex035 - create one RoutedEventArgs(PreviewItemActivatedEvent, source), raise it from source, then reassign its RoutedEvent to ItemActivatedEvent and raise the SAME args instance again from source; return the args");
}
