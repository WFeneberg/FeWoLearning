// Exercise 021 - Routed command binding (beginner).
...
public static class Ex021_RoutedCommandBinding
{
    ...
    public static void Wire(UIElement owner, ExecutedRoutedEventHandler executed, CanExecuteRoutedEventHandler canExecute)
        // TODO: owner.CommandBindings.Add(new CommandBinding(ApplicationCommands.Save, executed, canExecute));
        => throw new NotImplementedException("TODO: Ex021 - register a CommandBinding for ApplicationCommands.Save on owner.CommandBindings, wiring Executed and CanExecute to the supplied handlers");
}
