// Exercise 030 - Margin, Padding, and alignment (beginner).
...
public static class Ex030_MarginPaddingAlignment
{
    ...
    public static Border BuildBorder(Thickness margin, Thickness padding, HorizontalAlignment horizontal, VerticalAlignment vertical)
        ...
        //       };
        => throw new NotImplementedException("TODO: Ex030 - return a Border with Margin = margin, Padding = padding, HorizontalAlignment = horizontal, VerticalAlignment = vertical, and Child = new Border { Width = 40, Height = 20 }");
}
