// Exercise 066 - Localization: satellite resources and switching culture at runtime (intermediate).
...
public static class Ex066_Localization
{
    ...
    public static string GreetIn(CultureInfo culture)
        => throw new NotImplementedException("TODO: Ex066 - remember Thread.CurrentThread.CurrentUICulture, set it to `culture`, read Ex066_Strings.Greeting (which resolves via ResourceManager against whatever CurrentUICulture is ambient - not a value you pass to it), then restore the previous CurrentUICulture - even if reading the string throws - before returning what was read");
}
