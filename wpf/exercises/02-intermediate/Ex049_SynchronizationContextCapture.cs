// Exercise 049 - Why await returns to the UI thread, and the cost of ConfigureAwait(false) (intermediate).
...
public static class Ex049_SynchronizationContextCapture
{
    ...
    /// </summary>
    public static Task<(int AfterFirst, int AfterSecond)> RunKeepingContextAsync(Func<Task> work) =>
        throw new NotImplementedException("TODO: Ex049 - await work() (no ConfigureAwait), record Environment.CurrentManagedThreadId, await work() a second time, record it again, return both as a tuple");
    ...
    /// </summary>
    public static Task<(int AfterFirst, int AfterSecond)> RunWithConfigureAwaitFalseAsync(Func<Task> work) =>
        throw new NotImplementedException("TODO: Ex049 - await work().ConfigureAwait(false), record Environment.CurrentManagedThreadId, await work().ConfigureAwait(false) a second time, record it again, return both as a tuple");
}
