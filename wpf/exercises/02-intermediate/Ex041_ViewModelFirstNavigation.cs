// Exercise 041 - View-model-first navigation (intermediate).
...
public sealed class Ex041_NavigationShell : INotifyPropertyChanged
{
    ...
    private void AssignCurrentViewModel(ref object? field, object? value)
        => throw new NotImplementedException("TODO: Ex041 - compare field and value by reference (ReferenceEquals); if equal, do nothing; otherwise assign field = value and raise PropertyChanged for CurrentViewModel via RaisePropertyChanged(nameof(CurrentViewModel))");
