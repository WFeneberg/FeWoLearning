// Exercise 044 - IDataErrorInfo, the legacy validation interface (intermediate). REFERENCE SOLUTION.
...
public abstract class Ex044_LegacyValidatingViewModelBase : INotifyPropertyChanged, IDataErrorInfo
{
    ...
    /// <summary>Entity-level error - out of scope for this row.</summary>
    string IDataErrorInfo.Error => string.Empty;

    /// <summary>
    /// The legacy per-property indexer a Binding queries when ValidatesOnDataErrors is true.
    /// </summary>
    string IDataErrorInfo.this[string columnName] => GetError(columnName) ?? string.Empty;
    ...
    /// <summary>Raises PropertyChanged.</summary>
...
public static class Ex044_DataErrorInfoLegacy
{
    ...
    public static void BindWithLegacyValidation(TextBox target, object source, string propertyPath)
    {
        ...
        target.SetBinding(TextBox.TextProperty, new Binding(propertyPath)
        {
