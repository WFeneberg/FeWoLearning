// Exercise 023 - Implicit style keyed by type (beginner). REFERENCE SOLUTION.
...
/// <summary>
/// Ready to use - not the subject of this row. "Plain" unless an implicit style overrides
/// it.
/// </summary>
...
public static class Ex023_ImplicitStyleByType
{
    ...
    {
        var style = new Style(typeof(Ex023_Chip));
