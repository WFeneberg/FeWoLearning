...
public partial class Ex056_DataGridColumns : UserControl
{
    public Ex056_DataGridColumns()
    {
        ...
        throw new NotImplementedException(
            "TODO: Ex056 - include the DataGrid Fluent theme, then give Grid an " +
            "ItemsSource bound to Rows with two explicitly declared, non-auto-generated " +
            "DataGridTextColumns (Name, Age)");
    }
}
