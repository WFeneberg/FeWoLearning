...
public sealed class Ex069_ConditionalPlatformCode
{
    ...
    /// </summary>
    // A capability, not a name. The next platform, and the next version of this one, keep
    // working without an edit here.
    public string OpenDocumentTarget => _platform.SupportsMultipleWindows ? "window" : "tab";
    ...
    public string TelemetryTag =>
        _platform.Name.ToLowerInvariant() + (_platform.SupportsMultipleWindows ? "+multiwindow" : "");
}
