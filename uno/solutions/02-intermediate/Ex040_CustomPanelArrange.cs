...
public partial class Ex040_CustomPanelArrange : Panel
{
    ...
    protected override Size ArrangeOverride(Size finalSize)
    {
        ...
        foreach (var child in Children)
        {
            ...
            // Nothing clamps this. A rect reaching past finalSize positions the child
            // there anyway - which is what overlays rely on, and how children go missing
        ...
        // The bounding box actually used, not the slot that was offered. Returning
        // finalSize here is the reflex, and it makes the panel claim space it never used.
        return new Size(width, height);
    }
}
