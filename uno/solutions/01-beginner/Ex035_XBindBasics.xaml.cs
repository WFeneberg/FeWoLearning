...
public sealed partial class Ex035_XBindBasics : UserControl, INotifyPropertyChanged
{
    ...
    public string Caption
    {
        ...
        set
        {
            ...
            // The compiled OneWay binding subscribes to this event exactly like a classic
            // one. Compiled does not mean magic - a property that stays quiet stays quiet.
            Raise();
        }
    }

    /// <summary>The caption in upper case. Bound as a method call, not as a property.</summary>
    public string Shout() => Caption.ToUpperInvariant();
