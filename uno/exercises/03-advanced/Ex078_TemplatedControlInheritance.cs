...
public partial class Ex078_TemplatedControlInheritance : Ex078_BadgeBase
{
    ...
    public Ex078_TemplatedControlInheritance() =>
        // TODO: point DefaultStyleKey at this type. A subclass that leaves the base's key
        // in place looks up the base's default style and never gets its own.
        throw new NotImplementedException("TODO: Ex078 - claim this subclass's default style");
    ...
    protected override void UpdateVisualState() =>
        // TODO: let the base enter its own states first, count the update, then enter the
        // urgency state. Not calling the base drops availability entirely - and it compiles.
        throw new NotImplementedException("TODO: Ex078 - extend the base's state update");
