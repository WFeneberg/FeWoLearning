...
public partial class Ex073_InvalidationTracking : Panel
{
    ...
    private static void OnGutterChanged(DependencyObject sender, DependencyPropertyChangedEventArgs args) =>
        // TODO: the gutter changes the desired size. Mark the right pass dirty.
        throw new NotImplementedException("TODO: Ex073 - invalidate for a size-affecting change");

    private static void OnShiftChanged(DependencyObject sender, DependencyPropertyChangedEventArgs args) =>
        // TODO: the shift only moves children inside space the panel already has. Mark the
        // cheaper pass, and only that one - the test counts both.
        throw new NotImplementedException("TODO: Ex073 - invalidate for a position-only change");
}
