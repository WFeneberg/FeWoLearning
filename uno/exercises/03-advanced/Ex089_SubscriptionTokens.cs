...
public sealed class Ex089_SubscriptionTokens
{
    ...
    public IDisposable Subscribe(Action<string> handler) =>
        // TODO: store the handler and return something whose Dispose removes exactly this
        // subscription - not "the first handler equal to this one", which would unsubscribe
        // somebody else's identical lambda.
        throw new NotImplementedException("TODO: Ex089 - subscribe and hand back a token");

    /// <summary>Sends <paramref name="message"/> to every current handler.</summary>
    public int Publish(string message) =>
        // TODO: call them all and report how many. Publish over a snapshot: a handler that
        // unsubscribes while being called would otherwise mutate the list mid-iteration.
        throw new NotImplementedException("TODO: Ex089 - publish to the handlers");
    ...
    public static IDisposable Combine(params IDisposable[] tokens) =>
        throw new NotImplementedException("TODO: Ex089 - combine the tokens into one");
}
