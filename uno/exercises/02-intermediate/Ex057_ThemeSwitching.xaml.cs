...
public sealed partial class Ex057_ThemeSwitching : UserControl
{
    ...
    public void ApplyTheme(ElementTheme theme) =>
        throw new NotImplementedException("TODO: Ex057 - apply the theme to this subtree");
    ...
    public void ApplyThemeToWrapperOnly(ElementTheme theme) =>
        // TODO: find the wrapper by name and set its RequestedTheme. The property is on
        // FrameworkElement, so any element can start a new theme scope.
        throw new NotImplementedException("TODO: Ex057 - theme just the wrapper");
}
