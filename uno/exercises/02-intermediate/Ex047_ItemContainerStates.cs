...
public partial class Ex047_ItemContainerStates : ContentControl
{
    ...
    public void UpdateVisualState() =>
        throw new NotImplementedException("TODO: Ex047 - enter the matching selection state");
...
public sealed class Ex047_SelectionGroup
{
    ...
    public Ex047_SelectionGroup(params object[] items) =>
        throw new NotImplementedException("TODO: Ex047 - build the containers");

    /// <summary>The containers, in the order the items came in.</summary>
    public IReadOnlyList<Ex047_ItemContainerStates> Containers =>
        throw new NotImplementedException("TODO: Ex047 - expose the containers");

    /// <summary>The index of the selected container, or null when none is.</summary>
    public int? SelectedIndex =>
        // TODO: derive it from the containers rather than keeping a second copy of the
        // truth - a field here and the containers' IsSelected can only drift apart.
        throw new NotImplementedException("TODO: Ex047 - report which one is selected");
    ...
    public void Select(int index) =>
        throw new NotImplementedException("TODO: Ex047 - move the selection");
}
