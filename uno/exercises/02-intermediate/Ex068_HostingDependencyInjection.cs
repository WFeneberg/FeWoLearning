...
public static class Ex068_HostingDependencyInjection
{
    ...
    public static IHost CreateHost() =>
        // TODO: use Host.CreateDefaultBuilder (or the empty builder), register both, and
        // Build. Registering the view model as a singleton is the accident this exercise
        // is about - the test will notice.
        throw new NotImplementedException("TODO: Ex068 - build the host with both services");

    /// <summary>
    /// Resolves a view model from <paramref name="host"/>.
    /// </summary>
    public static Ex068_ViewModel ResolveViewModel(IHost host) =>
        // TODO: ask the provider. Note what is *not* here: no `new Ex068_ViewModel(...)`,
        // which is the whole point - the graph is described once, in CreateHost.
        throw new NotImplementedException("TODO: Ex068 - resolve a view model");
}
