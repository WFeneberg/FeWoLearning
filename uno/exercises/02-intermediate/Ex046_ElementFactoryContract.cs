...
public sealed class Ex046_ElementFactoryContract : IElementFactory
{
    ...
    public UIElement GetElement(object? data) =>
        // TODO: take from the pool or construct, count constructions, set the text.
        throw new NotImplementedException("TODO: Ex046 - hand out an element for the item");
    ...
    public void RecycleElement(UIElement element) =>
        throw new NotImplementedException("TODO: Ex046 - take the element back");
