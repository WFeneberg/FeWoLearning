...
public partial class Ex037_TemplatePartSubscriptions : Control
{
    ...
    // TODO: keep the part you are currently subscribed to. Nothing else can tell you which
    // element your handler is attached to once the template has moved on.
    ...
    protected override void OnApplyTemplate() =>
        // TODO: call the base implementation, detach from the old part, find the new one,
        // and attach to it. A template without the part leaves nothing attached.
        throw new NotImplementedException("TODO: Ex037 - move the subscription to the new part");
}
