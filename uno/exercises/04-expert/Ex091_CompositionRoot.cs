...
public static class Ex091_CompositionRoot
{
    ...
    public static IHost Build(Action<IServiceCollection>? overrides = null) =>
        // TODO: build the host, registering both, and apply the overrides after the
        // defaults - the last registration of a service wins, which is what makes this a
        // seam rather than a suggestion.
        throw new NotImplementedException("TODO: Ex091 - build the application graph");

    /// <summary>Resolves the capture view model.</summary>
    public static Ex091_CaptureViewModel Capture(IHost host) =>
        throw new NotImplementedException("TODO: Ex091 - resolve the view model");
}
