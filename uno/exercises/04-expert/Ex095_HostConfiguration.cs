...
public static class Ex095_HostConfiguration
{
    ...
    public static IHost Build(string environment, IReadOnlyDictionary<string, string?>? extra = null) =>
        // TODO: build it. AddInMemoryCollection takes the layers, order decides the winner,
        // and Configure<Ex095_ApiOptions> binds the section.
        throw new NotImplementedException("TODO: Ex095 - layer the configuration and bind it");

    /// <summary>The bound options.</summary>
    public static Ex095_ApiOptions Options(IHost host) =>
        // TODO: resolve IOptions<Ex095_ApiOptions> and hand back its Value. Reading
        // IConfiguration here instead would move the untyped edge into the app.
        throw new NotImplementedException("TODO: Ex095 - resolve the bound options");
    ...
    public static string? Raw(IHost host, string key) =>
        throw new NotImplementedException("TODO: Ex095 - read a raw configuration value");
}
