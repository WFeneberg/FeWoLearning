...
public static class Ex100_FeatureModules
{
    ...
    public static Ex100_Shell Compose(params IEx100_FeatureModule[] modules) =>
        // TODO: walk the modules, giving each one the service collection and the route
        // table. Wrap each module's registration so a throw is recorded against its name
        // and the others still load - a half-written module must not stop the app.
        //
        // Build the provider at the end, once, and hand back everything the shell knows.
        throw new NotImplementedException("TODO: Ex100 - compose the modules into a shell");

    /// <summary>
    /// The page type for a route, or null when no module claimed it.
    /// </summary>
    public static Type? Resolve(Ex100_Shell shell, string route) =>
        throw new NotImplementedException("TODO: Ex100 - resolve a route");
}
