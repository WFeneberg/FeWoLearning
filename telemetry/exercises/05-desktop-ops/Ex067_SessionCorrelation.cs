...
public static class Ex067_SessionCorrelation
{
    ...
    public static string SessionId =>
        throw new NotImplementedException("TODO: Ex067 - one random id per process run");
    ...
    public static string GetOrCreateInstallationId(string installationFilePath) =>
        throw new NotImplementedException(
            "TODO: Ex067 - create a random installation id once and persist it");
    ...
    public static Resource BuildResource(string installationFilePath) =>
        throw new NotImplementedException(
            "TODO: Ex067 - put both ids on the resource, where the exporter attaches them once");
}
