...
public static class Ex070_GracefulShutdownFlushInContainer
{
    ...
    public static TracerProvider Build(ICollection<Activity> delivered) =>
        throw new NotImplementedException(
            "TODO: Ex070 - build a batched pipeline that only moves when told to");

    /// <summary>Start and stop one <see cref="WorkSpanName"/> span.</summary>
    public static void DoWork() =>
        throw new NotImplementedException("TODO: Ex070 - emit one span");
    ...
    public static void FlushOnStopping(
        ...
        IList<string> log) =>
        throw new NotImplementedException(
            "TODO: Ex070 - flush while stopping, give up at the deadline, and let shutdown continue");
}
