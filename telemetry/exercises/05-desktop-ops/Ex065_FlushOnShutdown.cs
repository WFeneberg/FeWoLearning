...
public static class Ex065_FlushOnShutdown
{
    ...
    public static int Pending =>
        throw new NotImplementedException("TODO: Ex065 - expose how much has not left yet");
    ...
    public static TracerProvider Build(ICollection<Activity> delivered) =>
        throw new NotImplementedException(
            "TODO: Ex065 - build a batched pipeline that counts what has not been delivered");

    /// <summary>Start and stop one <see cref="WorkSpanName"/> span.</summary>
    public static void DoWork() =>
        throw new NotImplementedException("TODO: Ex065 - emit one span");
}
