...
public static class Ex061_CommandActivityTracing
{
    ...
    public static TracerProvider Build(ICollection<Activity> exported) =>
        throw new NotImplementedException("TODO: Ex061 - build a provider recording this source");
    ...
    /// </summary>
    public static Task<string> ExecuteSaveAsync(Dispatcher dispatcher, Func<Task<string>> save) =>
        throw new NotImplementedException(
            "TODO: Ex061 - wrap the whole command in one span that survives both hops");
    ...
    public static Task<string> PersistAsync() =>
        throw new NotImplementedException("TODO: Ex061 - do the work inside its own span");
}
