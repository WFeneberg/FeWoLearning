...
public static class Ex037_LogTraceCorrelation
{
    ...
    public static (ILoggerFactory Logs, TracerProvider Traces) Build(
        ...
        throw new NotImplementedException(
            "TODO: Ex037 - build a tracer provider and a logging pipeline into this exporter");
    ...
    public static string? LogInsideASpan(ILogger logger, string tenantId) =>
        throw new NotImplementedException(
            "TODO: Ex037 - log inside a span and a tenant scope, and report the trace id");

    /// <summary>Write ONE Information record reading "working" with no span in scope.</summary>
    public static void LogOutsideAnySpan(ILogger logger) =>
        throw new NotImplementedException("TODO: Ex037 - log the same message with no span open");
}
