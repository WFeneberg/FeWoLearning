...
public static class Ex030_Samplers
{
    ...
    public static TracerProvider Build(ICollection<Activity> exported, Sampler sampler) =>
        throw new NotImplementedException("TODO: Ex030 - build a provider with the given sampler");
    ...
    public static Activity? DoWork(ActivityContext parent = default) =>
        throw new NotImplementedException("TODO: Ex030 - start one span, optionally under an incoming parent");
    ...
    public static ActivityContext RemoteParent(bool sampled) =>
        throw new NotImplementedException("TODO: Ex030 - build a remote parent context with the given sampled flag");
}
