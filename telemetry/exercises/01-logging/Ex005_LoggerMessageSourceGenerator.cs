...
// implementation.
public static class Ex005_LoggerMessageSourceGenerator
{
    ...
    /// </summary>
    public static void CacheMiss(ILogger logger, string key, int attempts) =>
        throw new NotImplementedException(
            "TODO: Ex005 - replace this with a [LoggerMessage] partial method");
}
