...
public static class Ex057_BackendIngestion
{
    ...
    public static string ToClefLine(
        ...
        throw new NotImplementedException(
            "TODO: Ex057 - render one CLEF line: the template unrendered, the properties typed");
    ...
    public static string ToClefBatch(IEnumerable<string> lines) =>
        throw new NotImplementedException("TODO: Ex057 - join the lines the way the format expects");
}
