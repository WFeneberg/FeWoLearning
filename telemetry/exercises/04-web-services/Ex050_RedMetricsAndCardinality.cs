...
public static class Ex050_RedMetricsAndCardinality
{
    ...
    public static string BucketRoute(string? route) =>
        throw new NotImplementedException("TODO: Ex050 - keep the routes you serve, collapse the rest");

    /// <summary>
    /// The status dimension for <paramref name="statusCode"/>: "2xx", "3xx", "4xx" or
    /// "5xx", and "other" for anything outside 200-599.
    /// </summary>
    public static string BucketStatus(int statusCode) =>
        throw new NotImplementedException("TODO: Ex050 - reduce the status code to its class");
    ...
    public static void Record(string? route, int statusCode, double seconds) =>
        throw new NotImplementedException(
            "TODO: Ex050 - count the request and record its duration, on bounded dimensions");
}
