...
public static class Ex056_CollectorPipeline
{
    ...
    public static void DoCheckout(string email, string orderId) =>
        throw new NotImplementedException("TODO: Ex056 - emit the checkout span with both attributes");
    ...
    public static TracerProvider BuildOtlp(Uri tracesEndpoint, string serviceName) =>
        throw new NotImplementedException("TODO: Ex056 - build an OTLP pipeline aimed at the collector");
    ...
    public static string CollectorConfig() =>
        throw new NotImplementedException(
            "TODO: Ex056 - write the collector config that strips the attribute for every service at once");
}
