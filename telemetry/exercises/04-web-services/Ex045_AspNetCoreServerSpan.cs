...
public static class Ex045_AspNetCoreServerSpan
{
    ...
    public static void ConfigureTracing(IServiceCollection services, ICollection<Activity> exported) =>
        throw new NotImplementedException(
            "TODO: Ex045 - register the ASP.NET Core instrumentation and an in-memory exporter");
    ...
    public static void MapEndpoints(IEndpointRouteBuilder endpoints) =>
        throw new NotImplementedException("TODO: Ex045 - map the orders endpoint and nothing more");
}
