...
public sealed class Ex025_EventSourceAndCounters : EventSource
{
    ...
    public void BatchIngested(string batchId, int rows) =>
        throw new NotImplementedException("TODO: Ex025 - write event 1 with the batch id and row count");
    ...
    public void StoragePressure(int percent) =>
        throw new NotImplementedException("TODO: Ex025 - write event 2 with the percentage");
    ...
    public static IReadOnlyList<string> DiscoverEventSources() =>
        throw new NotImplementedException(
            "TODO: Ex025 - collect the names every EventSource announces to a listener");
}
