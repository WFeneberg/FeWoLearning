...
//
// Measured on this machine (Caliburn.Micro 5.0.258): IResult has exactly two members - Execute
// and the Completed event. There is no return value and no template method to override.
// TaskExtensions (in Caliburn.Micro) declares ExecuteAsync(this IResult, CoroutineExecutionContext
// = null) - the extension that runs a single IResult and hands back the Task that completes only
...
public class Ex041_LoggingResult : IResult
{
    ...
    /// <summary>The TODO: append Name to _log, then raise Completed - nothing else does it.</summary>
    public void Execute(CoroutineExecutionContext context) =>
        throw new NotImplementedException("TODO: Ex041 - append Name to _log, then raise Completed");
}
