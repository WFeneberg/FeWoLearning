...
//
// Measured on this machine (Caliburn.Micro 5.0.258), through WindowManager.ShowDialogAsync:
// TryCloseAsync(true) -> true, TryCloseAsync(false) -> false, TryCloseAsync(null) -> false.
...
{
    /// <summary>TODO: TryCloseAsync(true).</summary>
    public Task ConfirmAsync() =>
        throw new NotImplementedException("TODO: Ex048 - close with true");

    /// <summary>TODO: TryCloseAsync(false).</summary>
    public Task DeclineAsync() =>
        throw new NotImplementedException("TODO: Ex048 - close with false");

    /// <summary>TODO: TryCloseAsync(null).</summary>
    public Task DismissAsync() =>
        throw new NotImplementedException("TODO: Ex048 - close with null");
}
