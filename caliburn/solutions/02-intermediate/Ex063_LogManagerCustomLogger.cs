...
public class Ex063_RecordingLog : ILog
{
    ...
    public void Info(string format, params object[] args) => InfoMessages.Add(string.Format(format, args));

    public void Warn(string format, params object[] args) => WarnMessages.Add(string.Format(format, args));
...
public class Ex063_LogManagerCustomLogger
{
    ...
    public void Install(ILog log) => LogManager.GetLog = _ => log;
}
