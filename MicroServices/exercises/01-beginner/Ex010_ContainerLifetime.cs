...
public static class Ex010_ContainerLifetime
{
    public static void Configure(IDistributedApplicationBuilder builder)
        => throw new NotImplementedException(
            "TODO: ex010 - add container 'db' (image postgres) with a PERSISTENT "
            + "lifetime, container 'api' (image nginx) with an explicitly SESSION "
            + "lifetime, and container 'worker' (image busybox) left untouched.");
}
