...
public static class Ex028_MongoFirstConnection
{
    ...
    {
        // AddMongoDB models the server; AddDatabase adds a child whose connection
        // string is the same URI with "reviews" slotted into the path segment
        // between the authority and the "?authSource=..." query.
