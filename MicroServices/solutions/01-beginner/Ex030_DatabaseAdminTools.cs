...
public static class Ex030_DatabaseAdminTools
{
    ...
    {
        // Each of these three calls returns the STORE's builder, not the console's -
        // the console is a second resource added to the model on the side, linked
        // back with a ResourceRelationshipAnnotation.
        builder.AddPostgres("pg").WithPgAdmin();
        builder.AddMongoDB("docs").WithMongoExpress();
