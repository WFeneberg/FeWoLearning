...
public static class Ex029_RedisFirstConnection
{
    ...
    {
        // One call, one resource. There is no AddDatabase to chain here: a Redis
        // logical database is an integer you select on the connection, not a
        // resource in the graph.
        builder.AddRedis("cache");

        // The counterexample, in the same model so the contrast is measured rather
