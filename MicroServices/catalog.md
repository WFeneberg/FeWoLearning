...
| 029 | RedisFirstConnection | `AddRedis()` and `RedisResource`: a host:port with no scheme and **no database child resource**, which is exactly how Redis differs from the three above | ⬜ |
