//! Exercise 063 — Operator overloading via `std::ops` (intermediate).
//! Goal:   make `+` and `*` work naturally on a small vector type.
//! Drills: `impl std::ops::Add`, `impl std::ops::Mul<Scalar>`,
//!         `type Output`.
