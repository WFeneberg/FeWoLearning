...
impl ServerConfigBuilder<Missing, Missing> {
    ...
    pub fn new() -> Self {
        todo!("host: None, port: None, both fields PhantomData markers")
    }
}
...
impl<P> ServerConfigBuilder<Missing, P> {
    ...
    pub fn host(self, host: impl Into<String>) -> ServerConfigBuilder<Set, P> {
        todo!("carry `port` through unchanged, store the new host, flip H to Set")
    }
}
...
impl<H> ServerConfigBuilder<H, Missing> {
    ...
    pub fn port(self, port: u16) -> ServerConfigBuilder<H, Set> {
        todo!("carry `host` through unchanged, store the new port, flip P to Set")
    }
}
...
impl ServerConfigBuilder<Set, Set> {
    ...
    pub fn build(self) -> ServerConfig {
        todo!("unwrap host and port (guaranteed Some by the typestate) into a ServerConfig")
    }
}
